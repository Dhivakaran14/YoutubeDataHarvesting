...
youtube =build("youtube", "v3", developerKey="AIzaSyD2v7jViFdDG5T0-65utB5DSN7tJAhzUuc")
...
def migrate():
    ...
    if st.button("Upload Document to MYSQL"):
...
getyoutubedata = st.selectbox('Select Option', ['getdata', 'migrate', 'myquery'])
